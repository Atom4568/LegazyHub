...
function VLib:Window(text, textgame, textcircle)
  ...
  LeftFrame.Size = UDim2.new(0, 187, 0, 500)
  ...
  MainTitle.Position = UDim2.new(0.120, 0, 0.043, 0)
  ...
  GameTitle.Position = UDim2.new(0.120, 0, 0.078, 6)
  ...
  function VLib:Notification(textdesc)
    ...
    NotificationHold.BackgroundColor3 = Color3.fromRGB(45, 45, 45)
    ...
    OkayBtnCorner.CornerRadius = UDim.new(0, 0)
  ...
  function Tabs:Tab(text)
    ...
    UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(8, 134, 252)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(8, 134, 252))}
    ...
    function ContainerItems:Toggle(text,Default,callback)
      ...
      UIGradient_2.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(8, 134, 252)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(8, 134, 252))}
      ...
      if Toggled == true then
        ...
        ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(8, 134, 252)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(8, 134, 252))}
    ...
    function ContainerItems:Slider(text, min, max, start, callback)
      ...
      UIGradient_3.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(8, 134, 252)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(8, 134, 252))}
  ...
  local win = VLib:Window("BLOX FRUIT", "XNXX HUB", Color3.fromRGB(252, 83, 83))
  ...
  AutoFram:Toggle("Auto Farm (SelectWeaponOnly!)",false,function(vu)
  ...
  AutoFram:line()
  AutoFram:Toggle("Auto New World (SelectWeaponOnly!)",false,function(vu)
  AutoNew = vu
  end)
  spawn(function()
  while wait(.1) do
  ...
  AutoFram:Toggle("Auto Factory (SelectWeaponOnly!)",false,function(vu)
  Factory = vu
  end)
  function Click()
    game:GetService'VirtualUser':CaptureController()
  ...
  AutoFram:Toggle("Auto Superhuman (SelectWeaponOnly!)",false,function(vu)
  Superhuman = vu
  end)
  AutoFram:Toggle("Auto Death Step (SelectWeaponOnly!)",false,function(vu)
  DeathStep = vu
  end)
  spawn(function()
  while wait(.1) do
  ...
  local SelectWeaponDevil = AutoFram:Dropdown("Select Weapon (Weapon Attack Mon)",WaponMastery,function(Value)
        ...
        for i,v in pairs(game.Workspace.Enemies:GetDescendants()) do
          if FramBoss and v:IsA("Model") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and v.Name == MsBoss then
            repeat
              ...
              VirtualUser:ClickButton1(Vector2.new(50, 50), game:GetService("Workspace").Camera.CFrame)
              end)
  ...
  spawn(function()
  while wait(.1) do
    if Test == "Magnet" and AutoRengoku and StartMagnetRengoku then
      pcall(
      function()
        repeat
        ...
        until LocalPlayer.PlayerGui.Main.Quest.Visible == false or AutoRengoku == false or StartMagnet == false
      end
      )
    end
  end
  ...
  spawn(function()
  while wait(0.1) do
    if Test == "Magnet" and AFM and StartMagnet then
      CheckQuest()
      pcall(
      function()
        repeat
        ...
        until LocalPlayer.PlayerGui.Main.Quest.Visible == false or AFM == false or StartMagnet == true
      end
      )
    end
  end
  ...
  local Raids = win:Tab("Esp | Raid", "http://www.roblox.com/asset/?id=6023426915")
  ...
  while wait(.1) do
    if RaidsAura then
      for i,v in pairs(game.Workspace.Enemies:GetDescendants()) do
        if RaidsAura and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 500 then
          pcall(function()
          repeat wait(.1)
            print("")
          until not RaidsAura or not v.Parent or v.Humanoid.Health <= 0
          end)
        end
      end
    end
  ...
  local Fruit = win:Tab("DF Sniper", "http://www.roblox.com/asset/?id=6023426915")
  SelectDevil = ""
  Check = false
  Fruit:Dropdown(
  "Devil Fruit Sniper",
...
Setting:Button("Link Discord",function()
setclipboard("https://www.xnxx.com/")
VLib:Notification("Copy Succesfully")
end)
